...
const Banner = () => {
  return (
    <div
      className="hero min-h-[30rem] rounded-2xl"
      style={{
        backgroundImage:
        ...
        <div className="max-w-2xl flex flex-col items-center">
          ...
          <form className="w-full max-w-lg mt-6">
            <div className="flex items-center bg-white rounded-full shadow-lg overflow-hidden">
              ...
              />
              <button className="bg-primary-500 text-black cursor-pointer font-bold py-3 px-6 m-1 rounded-full hover:bg-primary-600 transition-all">
                <MdSearch size={30}/>
              </button>
            </div>
          </form>
